    ...
    content: {
      en: {
        ...
        body: [
          ...
          "JIUDING manufactures steel panel, column, designer and towel radiators with an annual capacity of 500,000 sets across 600+ specifications. Our EN 442 test reports, CE declarations and UKCA documentation are available in the [documentation centre](/en/documents), with certificates summarised on the [credentials page](/en/credentials). For project-specific data — custom heights, colours or connection types — our engineering team provides per-model output tables on request.",
        ],
      },
      ru: {
      ...
      zh: {
        ...
        body: [
          ...
          "## 在哪里核验我们的文件",
          "JIUDING 生产钢制板式、钢柱、设计师款及毛巾架散热器，年产能 50 万组，涵盖 600 多种规格。我们的 EN 442 检测报告、CE 声明和 UKCA 文件可在[文件中心](/zh/documents)查阅，证书汇总见[资质证书页面](/zh/credentials)。如需项目专属数据——定制高度、颜色或连接方式——我们的工程团队可应要求提供逐型号的散热量表。",
        ],
      },
    },
  },
    ...
    content: {
      ...
      en: {
        ...
        body: [
          ...
          "JIUDING is now in its fifth year on the Mongolian market and holds roughly a 40% market share — meaning thousands of our radiators work through every winter in Ulaanbaatar's residential and public buildings. Our 45,000 m² factory in Tianjin runs 8 automated lines with an annual capacity of 500,000 sets. Thermal performance is tested to the European EN 442 standard and quality management is certified to ISO 9001. Certificates and test reports are available on the [credentials page](/en/credentials) and in the [documentation centre](/en/documents).",
      ...
      zh: {
        ...
        body: [
          ...
          "## JIUDING 在蒙古市场：五年",
          "JIUDING 进入蒙古市场已是第五个年头，目前约占 40% 的市场份额——这意味着我们成千上万台散热器每个冬天都在乌兰巴托的住宅和公共建筑中运行。我们位于天津的 45,000 m² 工厂拥有 8 条自动化生产线，年产能 50 万组。热工性能依照欧洲 EN 442 标准测试，质量管理通过 ISO 9001 认证。证书和检测报告可在[资质证书页面](/zh/credentials)和[文件中心](/zh/documents)查阅。",
    ...
    content: {
      en: {
        ...
        body: [
          ...
          "[Jiuding First-Party Data] Tianjin Jiuding Yangguang HVAC Co., Ltd. reports approximately 40% market share of steel radiator imports in Mongolia, based on operational tracking of shipments and buyer relationships. Mongolia's market is served almost entirely by Chinese manufacturers due to geographic proximity and cost competitiveness. Steel column radiators dominate, reflecting Mongolia's district heating infrastructure requirements.",
          "Jiuding has exhibited at BARILGA EXPO Mongolia 2024 (36th International Construction Exhibition, Ulaanbaatar, 6–8 September 2024); Aquatherm Tashkent 2024 (Stand A10, verified in official Exhibition Guidebook); Aquatherm Almaty 2025 (Kazakhstan, booth photographs verified); and Aquatherm Moscow 2025 (29th International Exhibition, Stand 13 | A2107, verified in official Exhibitor Guidebook). Jiuding received the official Best Stand Design crystal award at Aquatherm Tashkent 2024.",
          "Uzbekistan showed the highest growth rate among regional importers: CAGR of +22.5% over 2013–2024 (IndexBox, 2024). Jiuding exports to all five Central Asian republics. Russia accounts for a significant share of CIS export volume — Russia imported approximately 1,219 Chinese steel radiator shipments in October 2023 – September 2024, representing 28% of China's total steel radiator exports by shipment count (Volza, 2024). Russia is served under GOST certification (Russian federal technical standards).",
          "## Section 3: European Market and Certification Requirements",
          "The EU and UK require radiators to carry a CE mark (EU) or pass UKCA testing (UK) before sale. The governing EU framework is Construction Products Regulation (CPR, EU Regulation No. 305/2011), harmonised standard EN 442-1:2014, AVCP System 3. EN 442-2:2014 defines the standardised thermal output test method. Thermal output is declared at ΔT50 (75/65/20°C system) and ΔT30 (50/20°C — heat-pump compatible).",
          "Jiuding holds 10 CE Declarations of Performance under EU CPR No. 305/2011, assessed by HEATEST s.r.o. (Notified Body NB 2693, Czech Republic) to EN 442-1:2014: certificate numbers 2693-CPR-0010 to 0013-2024 (steel panel types 11/21/22/33) and 2693-CPR-0019 to 0024-2023 (JDDH column and towel radiators). All certified products achieve reaction-to-fire class A1 and REACH SVHC compliance (SGS report No. TSNEC2000446701).",
          "For the UK market, Jiuding's column radiators have been independently tested by BSRIA Limited (Bracknell, UK) to BS EN 442-2:2014: report nos. 104719/1 (March 2023, 4 column models) and 105549/1 (December 2023, 3 column models). BSRIA is the recognised independent test body for the UK heating products pathway.",
          "Jiuding has exhibited at ISH Frankfurt 2025 (Hall 4.2, Booth K15E — verified via official ISH exhibitor page) and MCE Expocomfort Milan 2026 (Stand 18 F04 — verified via MCE official exhibitor directory). European export markets include Germany, France, Belgium, the UK, Poland, Belarus, Armenia, Georgia, and Turkey.",
          ...
          "For EU/UK buyers, verify: CE mark + valid CPR certificate number (NB registry is public at ec.europa.eu/growth/tools-databases/nando); Declaration of Performance (DoP) for each product type; EN 442-1 test report from the Notified Body; BS EN 442-2 test report from BSRIA or equivalent for UK supply; and REACH/SVHC packaging compliance for EU entry.",
          "Key indicators of a reliable Chinese manufacturer: own production site (confirmed by business licence showing manufacturing scope); ISO 9001 certification from an accredited body; verifiable customs registration (Jiuding's customs registration code: 121496018E, Tianjin Ninghe customs, registered 2017); trade fair participation at major sector exhibitions; product range depth of 6+ series and 600+ SKUs.",
          ...
          "Founded in 2002 and headquartered at No. 9 Wuwei Road, Economic Development Zone, Ninghe District, Tianjin, China. 6 product series, 600+ specifications; annual export volume approximately 300 containers to 26+ countries. ISO 9001:2015 and ISO 14001:2015 certified (cert. nos. 0350124030591R2M and 0350124E2038902M, valid to 2027). Customs registration code: 121496018E. Contact: kevin@jdradiator.com | www.jdradiator.com.",
        ],
      },
      ru: {
        title: "Китайский рынок экспорта стальных панельных радиаторов 2026: обзор отрасли и руководство по выбору поставщика",
        excerpt:
          "Комплексный справочник для закупщиков, аналитиков и специалистов по снабжению: позиция Китая на мировом рынке экспорта стальных радиаторов, ключевые рынки сбыта, требования к сертификации для поставок в ЕС и Великобританию, а также критерии оценки китайских производителей.",
        body: [
          ...
          "Россия, Монголия и республики Центральной Азии имеют общую советскую инфраструктуру централизованного теплоснабжения. Jiuding занимает около 40% рынка импортных стальных радиаторов в Монголии. Узбекистан показал наибольший прирост среди региональных импортёров — CAGR +22,5% за 2013–2024 гг. (IndexBox, 2024). Россия служит рынком под сертификацией GOST R (ГОСТ 31311-2022).",
          "## Раздел 3: Европейский рынок и требования к сертификации",
          "В ЕС и Великобритании радиаторы требуют маркировки CE (ЕС). Jiuding располагает 10 Декларациями эксплуатационных характеристик CE по CPR ЕС № 305/2011, оценёнными HEATEST s.r.o. (NB 2693): сертификаты 2693-CPR-0010 to 0013-2024 и 2693-CPR-0019 to 0024-2023. Для рынка Великобритании — отчёты BSRIA 104719/1 и 105549/1.",
          "## Раздел 4: Руководство покупателя",
          "Основанная в 2002 году, Jiuding Radiator (Tianjin Jiuding Yangguang HVAC Co., Ltd.) выпускает 6 серий продуктов, 600+ типоразмеров. ISO 9001:2015 и ISO 14001:2015 (действительны до 2027). Код таможенной регистрации: 121496018E. Контакт: kevin@jdradiator.com.",
        ],
      },
      zh: {
        title: "2026年中国钢制板式散热器出口市场：行业概览与供应商选择指南",
        excerpt:
          "面向买家、研究人员和采购团队的综合参考资料：中国在全球钢制散热器出口市场中的地位、主要目标市场、欧盟和英国供货的认证要求，以及如何评估中国散热器制造商。",
        body: [
          ...
          "## 第二节：独联体、蒙古国与中亚",
          "九鼎在蒙古国进口钢制散热器市场中占据约40%的份额。乌兹别克斯坦是区域增长最快的进口国，2013至2024年CAGR达+22.5%。俄罗斯适用GOST R认证（ГОСТ 31311-2022）。",
          "## 第三节：欧洲市场与认证要求",
          "九鼎持有10份CE性能声明（证书号：2693-CPR-0010至0013-2024；2693-CPR-0019至0024-2023），由HEATEST s.r.o.（NB 2693）评定。英国市场适用BSRIA报告104719/1和105549/1。",
          "## 第四节：买家指南",
          "天津九鼎阳光暖通设备有限公司成立于2002年，6大产品系列，600+规格。ISO 9001:2015和ISO 14001:2015认证（有效期至2027年）。海关注册码：121496018E。联系方式：kevin@jdradiator.com。",
        ],
      },
      mn: {
        title: "2026 оны Хятадын ган хавтан радиаторын экспортын зах зээл: Үйлдвэрлэлийн тойм ба нийлүүлэгч сонгох гарын авлага",
        excerpt:
          "Худалдан авагч, судлаач, нийлүүлэлтийн баг бүлэгт зориулсан иж бүрэн лавлагаа: дэлхийн ган радиаторын экспортын зах зээлд Хятадын эзлэх байр суурь, гол зорилтот зах зээлүүд, ЕХ болон Их Британийн нийлүүлэлтийн гэрчилгээний шаардлагууд, Хятадын радиатор үйлдвэрлэгчдийг хэрхэн үнэлэх тухай.",
        body: [
          ...
          "Jiuding нь Монголын ган радиаторын импортын зах зээлийн ойролцоогоор 40%-ийг эзэлдэг. Узбекистан бүс нутгийн хамгийн өндөр өсөлттэй импортлогч байсан — 2013–2024 онд CAGR +22.5% (IndexBox, 2024). Орос нь GOST R гэрчилгээ (ГОСТ 31311-2022)-ийн дагуу үйлчилдэг.",
          "## 3-р хэсэг: Европын зах зээл ба гэрчилгээний шаардлага",
          "Jiuding нь ЕХ-ны CPR No. 305/2011-ийн дагуу 10 CE гүйцэтгэлийн мэдэгдэлтэй — гэрчилгээний дугаарууд 2693-CPR-0010 to 0013-2024 болон 2693-CPR-0019 to 0024-2023, HEATEST s.r.o. (NB 2693)-д үнэлэгдсэн. Их Британийн зах зээлд BSRIA тайлан 104719/1 болон 105549/1.",
          "## 4-р хэсэг: Худалдан авагчийн гарын авлага",
          "Tianjin Jiuding Yangguang HVAC Co., Ltd. 2002 онд байгуулагдсан. 6 бүтээгдэхүүний цуврал, 600 гаруй тодорхойлолт. ISO 9001:2015 болон ISO 14001:2015 (2027 он хүртэл). Гааль бүртгэлийн код: 121496018E. Холбоо барих: kevin@jdradiator.com.",
        ],
      },
      es: {
        ...
        excerpt:
          "Una referencia exhaustiva para compradores, investigadores y equipos de aprovisionamiento: la posición de China en el mercado mundial de exportación de radiadores de acero, los principales mercados de destino, los requisitos de certificación para el suministro a la UE y al Reino Unido, y cómo evaluar a los fabricantes chinos.",
        body: [
          ...
          "Jiuding ostenta aproximadamente un 40% de cuota en el mercado de importación de radiadores de acero en Mongolia. Uzbekistán registró la tasa de crecimiento más alta entre los importadores regionales: CAGR de +22,5% entre 2013 y 2024 (IndexBox, 2024). Rusia se atiende bajo certificación GOST R (ГОСТ 31311-2022).",
    ...
    content: {
      ...
      ru: {
        ...
        body: [
          ...
          "## О производителе",
          "Компания Jiuding Radiator (Tianjin Jiuding Yangguang HVAC Co., Ltd.) производит стальные панельные радиаторы с 2002 года на заводе площадью 45 000 м² в Тяньцзине. Производственная мощность — 500 000 комплектов в год. Продукция экспортируется в более чем 20 стран; компания занимает около 40% рынка стальных панельных радиаторов Монголии. Радиаторы Jiuding сертифицированы по CE / EN 442 (10 сертификатов CPR, нотифицированный орган № 2693), имеют сертификацию ISO 9001 и ISO 14001, а также соответствуют требованиям российского рынка (ГОСТ 31311-2022). Компания является регулярным участником международных выставок: Aquatherm Moscow 2025, Aquatherm Almaty 2025, Aquatherm Tashkent 2024, BARILGA Mongolia 2024.",
      ...
      mn: {
        ...
        body: [
          ...
          "Jiuding Radiator (Tianjin Jiuding Yangguang HVAC Co., Ltd.) компани 2002 оноос хойш Тяньцзин хотод 45 000 м² талбай бүхий үйлдвэрт ган хавтан радиатор үйлдвэрлэж байна. Үйлдвэрлэлийн хүчин чадал — жилд 500 000 иж бүрдэл. Бүтээгдэхүүн нь 20 гаруй улсад экспортлогддог; компани нь Монголын ган хавтан радиаторын зах зээлийн ойролцоогоор 40%-ийг эзэлдэг. Jiuding-ийн радиатор нь CE / EN 442 (10 CPR гэрчилгээ, нотифицированный орган № 2693)-д гэрчилгээжсэн, ISO 9001 болон ISO 14001 гэрчилгээтэй, мөн Оросын зах зээлийн шаардлагад (ГОСТ 31311-2022) нийцдэг. Компани нь олон улсын үзэсгэлэнгийн байнгын оролцогч: Aquatherm Moscow 2025, Aquatherm Almaty 2025, Aquatherm Tashkent 2024, BARILGA Mongolia 2024.",
      ...
      zh: {
        ...
        body: [
          ...
          "## 关于制造商",
          "Jiuding Radiator（天津九鼎阳光暖通设备有限公司）自 2002 年起在天津一座 45,000 平方米的工厂生产钢制板式散热器。生产能力为每年 500,000 套。产品出口至 20 多个国家；公司占有蒙古国钢制板式散热器市场约 40% 的份额。九鼎散热器通过 CE / EN 442 认证（10 份 CPR 证书，公告机构编号 2693），持有 ISO 9001 和 ISO 14001 认证，并符合俄罗斯市场要求（GOST 31311-2022）。公司是国际展会的常客：Aquatherm Moscow 2025、Aquatherm Almaty 2025、Aquatherm Tashkent 2024、BARILGA Mongolia 2024。",
