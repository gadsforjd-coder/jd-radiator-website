...
export const productDescriptions: Record<string, Record<string, string>> = {
  "jd25y": {
    zh: "JD25Y 是九鼎搭焊系列的代表款设计型散热器，以细密排列的 Φ25 立管搭配 Φ35 主管，勾勒出简洁利落的垂直线条——既是供暖设备，也是墙面上的一件装饰。可选单排 / 双排结构，散热量覆盖 449–1476 W，适配 600 / 1500 / 1800 mm 多种高度，竖装横装皆宜，尤其适合客厅、玄关、卧室等注重格调的空间。整机采用优质低碳钢焊接成型，表面经多道喷涂处理，提供亮光 / 柔光 / 哑光三种质感，标准白色之外还有烟煤灰、黑色，也可按 RAL 色卡定制。通过 CE / EN442 认证，工作压力 1.0 MPa，自 2002 年起出口 26 个国家，支持 OEM / ODM 定制尺寸、颜色与包装。",
    en: "The JD25Y is a signature designer radiator from Jiuding's welded series. Slender Φ25 vertical tubes paired with a Φ35 header form clean, upright lines — a heating appliance that doubles as a piece of wall décor. Available in single- or double-panel builds, it delivers 449–1476 W across 600 / 1500 / 1800 mm heights and mounts vertically or horizontally, a natural fit for living rooms, hallways and bedrooms where looks matter. Welded from premium low-carbon steel and finished with a multi-coat powder process, it comes in glossy, reluster or matte textures — standard white plus anthracite and black, or any custom RAL shade. CE / EN442 certified and rated to 1.0 MPa, the JD25Y has been exported to 26+ countries since 2002, with OEM / ODM support for custom sizes, colours and packaging.",
  },
  "jd-11k": {
    zh: "JD-11K 板式散热器采用单面板单对流片结构（Type 11），钢制冷轧板材粉末喷涂白色 RAL 9016，外观简洁耐用。散热量范围 400–2800 W，可选高度 300–900 mm，适配多种空间尺寸需求。工作压力 1.0 MPa，符合 CE/EN442 标准，自2002年起出口 26 个国家，支持 OEM/ODM 定制。高性价比首选，快速升温，安装简便。",
    en: "The JD-11K is a Type 11 panel radiator featuring a single panel and single convector construction, delivering a heat output range of 400–2800 W across heights from 300 to 900 mm. Manufactured from cold-rolled steel with a powder-coated White RAL 9016 finish, it meets CE/EN442 standards and operates at up to 1.0 MPa (10 bar). Exported to 26+ countries since 2002, with OEM/ODM services available — an economical and reliable choice for residential and commercial heating.",
  },
  "jd-21k": {
    zh: "JD-21K 板式散热器采用双面板单对流片结构（Type 21），在紧凑厚度下提升散热量至 306–3694 W，可选高度 300–700 mm，适合层高受限或墙下安装场景。钢制冷轧板材粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年出口 26 个国家，支持 OEM/ODM，是兼顾功率与空间效率的高性价比方案。",
    en: "The JD-21K is a Type 21 panel radiator combining double panels with a single convector to deliver 306–3694 W across heights from 300 to 700 mm — ideal for installations with limited wall height. The cold-rolled steel body carries a powder-coated White RAL 9016 finish, complying with CE/EN442 standards at a working pressure of 1.0 MPa (10 bar). Exported globally to 26+ countries since 2002, with full OEM/ODM capability for custom specifications.",
  },
  "jd-22k": {
    zh: "JD-22K 板式散热器采用双面板双对流片结构（Type 22），散热量范围 700–5200 W，是同等宽度板式散热器中功率最强的主流型号之一。可选高度 300–900 mm，钢制冷轧板粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年出口 26 个国家，支持 OEM/ODM，大功率快速升温，广泛适用于卧室、客厅及商业空间。",
    en: "The JD-22K Type 22 panel radiator features double panels and double convectors for exceptional heat output of 700–5200 W, making it one of the most powerful mainstream panel radiators available. Available in heights from 300 to 900 mm with a powder-coated White RAL 9016 finish on cold-rolled steel, it complies with CE/EN442 at 1.0 MPa (10 bar). Exported to 26+ countries since 2002 with OEM/ODM support — the go-to choice for demanding residential and light commercial heating applications.",
  },
  "jd-33k": {
    zh: "JD-33K 板式散热器采用三面板三对流片结构（Type 33），散热量高达 1100–8000 W，是板式系列中功率最强的型号，专为大空间及高热负荷场景设计。可选高度 300–900 mm，钢制冷轧板粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年出口 26 个国家，支持 OEM/ODM，极速升温，适用于大型客厅、展厅、工业厂房等高功率需求场合。",
    en: "The JD-33K is the highest-output model in the panel radiator range, combining triple panels and triple convectors for heat delivery of 1100–8000 W — designed for large spaces and high heat-load requirements. Available in heights from 300 to 900 mm, the cold-rolled steel body carries a powder-coated White RAL 9016 finish and complies with CE/EN442 standards at 1.0 MPa (10 bar). Backed by over two decades of export experience to 26+ countries since 2002, with OEM/ODM manufacturing services available.",
  },
  "jd132-60tl": {
    zh: "JD132/60TL 铜铝复合散热器以宽体 132×60 mm 截面为特点，铜管穿铝翅片结构提供超大散热面积与高效热传导，每片散热量达 160–280 W，适合需要较大供热量的大面积房间。工作压力 1.6 MPa（16 bar），耐压防腐，静电粉末喷涂。通过 CE / EN442 认证，自 2002 年起出口 26 个国家，支持 OEM / ODM 定制。",
    en: "The JD132/60TL bimetal radiator features a wide 132×60 mm section, with a copper-tube-through-aluminium-fin construction that delivers an exceptional heat-exchange surface and outstanding thermal conductivity — 160–280 W per section for large rooms with high heating demands. Rated 1.6 MPa (16 bar), pressure-resistant and corrosion-proof, powder-coated finish. CE / EN442 certified and exported to 26+ countries since 2002, with OEM / ODM support for custom configurations.",
  },
  "jd25-28": {
    zh: "JD25/28 是九鼎搭焊系列中的横式设计款散热器，以密排 Φ25×28 方扁管搭配 Φ35 主管，呈现出宽幅低矮的水平线条——横置于窗下如同一道精致的建筑腰线。可选单排/双排结构，散热量覆盖 474–2824 W，适配 600/1500/1800 mm 三种高度，满足不同空间的供暖需求。采用低碳钢管焊接成型，表面提供光泽/哑光/Reluster 三种处理，白色、炭灰、黑色及 RAL 定制色均可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口全球 26 个国家，支持 OEM/ODM 定制尺寸、颜色与包装。",
    en: "The JD25/28 is a horizontal designer radiator from Jiuding's welded series, featuring densely arranged Φ25×28 rectangular tubes paired with Φ35 headers that create a wide, low-profile silhouette — a refined architectural band beneath any window. Available in single or double panel configurations, heat output ranges from 474 to 2824 W across heights of 600, 1500, and 1800 mm. Constructed from low-carbon steel with a choice of Glossy, Matte, or Reluster finish in White, Anthracite, Black, or custom RAL colours. CE/EN442 certified, rated at 1.0 MPa working pressure, exported to 26+ countries since 2002, with full OEM/ODM support for custom dimensions, colours, and packaging.",
  },
  "jd30-15": {
    zh: "JD30/15 是九鼎搭焊系列的超薄竖管设计款，采用 Φ30×15 扁管搭配 Φ35 主管，以极致纤薄的截面构成密集排列的垂直线条，整体轻盈通透，是对现代极简美学的诚意呈现。可选单排/双排结构，散热量覆盖 203–1116 W，适配 600/1200/1800 mm 三种高度。低碳钢焊接成型，光泽/哑光/Reluster 三种表面处理，白色、炭灰、黑色及 RAL 定制色可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口全球 26 个国家，支持 OEM/ODM 定制尺寸、颜色与包装。",
    en: "The JD30/15 brings ultra-slim Φ30×15 flat tubes together with Φ35 headers in Jiuding's welded designer series, creating a densely layered vertical arrangement with a near-transparent depth profile — a study in minimalist warmth. Single or double panel configurations span 203–1116 W across 600, 1200, and 1800 mm height options. Low-carbon steel construction with Glossy, Matte, or Reluster surface treatments; White, Anthracite, Black, and custom RAL colour options. CE/EN442 certified, 1.0 MPa working pressure, shipped to 26+ countries since 2002, with OEM/ODM support for bespoke dimensions, finishes, and packaging.",
  },
  "jd30f": {
    zh: "JD30F 是九鼎搭焊系列的细竖管设计款，以 Φ30×30 方管搭配 Φ35 主管，勾勒出修长挺拔的垂直线条，挂于墙面如同一组精密排列的现代立柱，兼顾采暖功能与室内装饰美感。可选单排/双排结构，散热量覆盖 270–1488 W，适配 600/1200/1800 mm 三种高度。采用低碳钢焊接，提供光泽/哑光/Reluster 表面处理，白色、炭灰、黑色及 RAL 定制色均可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口 26 个国家，支持 OEM/ODM 定制。",
    en: "The JD30F is a slim vertical designer radiator from Jiuding's welded range, pairing Φ30×30 square tubes with Φ35 headers to achieve a tall, refined column aesthetic that doubles as a decorative wall feature. Single or double panel options deliver 270–1488 W across heights of 600, 1200, and 1800 mm. Welded from low-carbon steel with Glossy, Matte, or Reluster finishes available in White, Anthracite, Black, or custom RAL colours. CE/EN442 certified, 1.0 MPa working pressure, exported to 26+ countries since 2002, with OEM/ODM customisation on dimensions, colours, and packaging.",
  },
  "jd30slf": {
    zh: "JD30SLF 是九鼎卫浴系列的扁管毛巾架散热器，采用优质低碳钢Φ30扁管焊接成型，挂杆结构宽敞，兼具毛巾烘干与浴室供暖两大功能。表面提供白色亮光与镀铬两种饰面，耐潮防锈，适合各种卫浴风格。散热量 300–800 W，工作压力 1.0 MPa，通过 CE / EN442 认证，自 2002 年起出口 26 个国家，支持 OEM / ODM 定制尺寸与饰面。",
    en: "The JD30SLF is a flat-tube towel rail radiator from Jiuding's bathroom series, welded from premium low-carbon steel Φ30 flat tubes for a clean ladder structure that excels at drying towels and heating the bathroom simultaneously. Available in glossy white or chrome finish for moisture-resistant durability in any bathroom style. Rated 300–800 W output, 1.0 MPa working pressure, CE / EN442 certified. Exported to 26+ countries since 2002, with OEM / ODM support for custom sizes and finishes.",
  },
  "jd40-12l": {
    zh: "JD40/12L 是九鼎搭焊系列的大径超细竖管款，Φ40×12 扁管搭配 Φ35 主管，管间距极小，呈现出近乎实体感的密排立柱墙面造型，细腻的 L 型管头设计更增添结构层次感。仅提供 1500/1800 mm 两种高度，散热量覆盖 336–2009 W，单排/双排可选。低碳钢焊接成型，光泽/哑光/Reluster 表面处理，白色、炭灰、黑色及 RAL 定制色均可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口 26 个国家，支持 OEM/ODM 定制。",
    en: "The JD40/12L features tightly-pitched Φ40×12 flat tubes paired with Φ35 headers in Jiuding's welded designer series, producing an almost solid wall of vertical fins with distinctive L-profile tube ends that add structural depth and visual interest. Available in 1500 and 1800 mm heights, with heat output from 336 to 2009 W in single or double panel configurations. Low-carbon steel, Glossy/Matte/Reluster finishes, White/Anthracite/Black or custom RAL colours. CE/EN442 certified, 1.0 MPa working pressure, exported to 26+ countries since 2002, with full OEM/ODM customisation.",
  },
  "jd40-15": {
    zh: "JD40/15 是九鼎搭焊系列中截面比例最为均衡的款式，Φ40×15 扁管搭配 Φ35 主管，宽而薄的竖管呈现出宽幅平整的立面，线条简洁大方，适配多样室内风格。可选单排/双排，散热量覆盖 400–1958 W，高度选项最为丰富：600/1500/1800/2000 mm。低碳钢焊接，光泽/哑光/Reluster 三种表面处理，白色、炭灰、黑色及 RAL 定制色可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口全球 26 个国家，支持 OEM/ODM 定制尺寸、颜色与包装。",
    en: "The JD40/15 offers one of the most versatile profiles in Jiuding's welded designer range, with Φ40×15 flat tubes and Φ35 headers forming a broad, flat vertical face that adapts to both contemporary and classic interiors. Single or double panel options cover 400–1958 W, with the widest height selection in the series: 600, 1500, 1800, and 2000 mm. Low-carbon steel construction, Glossy/Matte/Reluster finishes, White/Anthracite/Black or custom RAL colours. CE/EN442 certified, 1.0 MPa working pressure, shipped to 26+ countries since 2002, with OEM/ODM support for custom sizing and finishes.",
  },
  "jd40": {
    zh: "JD40 是九鼎搭焊系列的圆管设计款，以 Φ40 圆立管搭配 Φ35 主管，饱满圆润的管型与柔和曲线赋予空间温暖而有力的视觉质感，兼具极简工业风与北欧家居气质。可选单排/双排，散热量覆盖 300–1800 W，适配 600/1200/1500/1800 mm 四种高度。低碳钢焊接，光泽/哑光/Reluster 表面处理，白色、炭灰、黑色及 RAL 定制色均可选。通过 CE/EN442 认证，工作压力 1.0 MPa，自 2002 年起出口 26 个国家，支持 OEM/ODM 定制。",
  ...
  "jdsc": {
    ...
    en: "The JDSC decorative column radiator breaks the flat plane with its striking S-curve silhouette, turning functional heating into a sculptural interior feature. Constructed from low-carbon steel with a working pressure of 1.0 MPa and an output of 400–2000 W, it is available in heights from 600 to 1800 mm in a range of RAL colours. CE-certified to EN442, exported to 26+ countries since 2002, with OEM/ODM development support.",
  },
  "jdwy-c": {
    zh: "JDWY(C) 弯管毛巾架采用Φ25圆管弯曲成型，挂杆呈弧形排列，兼具毛巾烘干与卫浴供暖功能，线条柔和流畅。低碳钢材质，表面白色或镀铬处理，耐湿防腐。散热量 300–900 W，工作压力 1.0 MPa，通过 CE / EN442 认证，自 2002 年起出口 26 个国家，支持 OEM / ODM 定制。",
    en: "The JDWY(C) curved towel rail features Φ25 round tubes bent into a graceful arc, delivering both towel drying and bathroom heating in a design with smooth, flowing lines. Made from low-carbon steel with a white or chrome finish for lasting corrosion resistance in humid environments. Rated 300–900 W, 1.0 MPa working pressure, CE / EN442 certified. Exported to 26+ countries since 2002, with OEM / ODM customisation available.",
  },
  "jdwy-s": {
    zh: "JDWY(S) 直管毛巾架采用Φ25圆管直管结构，挂杆排列整齐，线条简洁挺拔，同时兼顾毛巾烘干与浴室供暖双重需求。低碳钢材质，白色或镀铬饰面，防潮耐用。散热量 300–900 W，工作压力 1.0 MPa，通过 CE / EN442 认证，自 2002 年起出口 26 个国家，支持 OEM / ODM 定制。",
    en: "The JDWY(S) straight towel rail uses Φ25 round straight tubes arranged in a clean, upright ladder structure, serving dual duty as a towel dryer and bathroom radiator. Low-carbon steel construction with white or chrome finish for moisture resistance and long service life. Rated 300–900 W, 1.0 MPa working pressure, CE / EN442 certified. Exported to 26+ countries since 2002, with OEM / ODM support for custom dimensions and finish.",
  },
};
