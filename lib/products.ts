...
export const productDescriptions: Record<string, Record<string, string>> = {
  ...
  "jd-21k": {
    zh: "JD-21K 板式散热器采用双面板单对流片结构（Type 21），在紧凑厚度下提升散热量至 306–3694 W，可选高度 300–700 mm，适合层高受限或墙下安装场景。钢制冷轧板材粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年起出口至欧洲、俄罗斯及中亚市场，支持 OEM/ODM，是兼顾功率与空间效率的高性价比方案。",
  ...
  "jd-22k": {
    zh: "JD-22K 板式散热器采用双面板双对流片结构（Type 22），散热量范围 700–5200 W，是同等宽度板式散热器中功率最强的主流型号之一。可选高度 300–900 mm，钢制冷轧板粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年起出口至欧洲、俄罗斯及中亚市场，支持 OEM/ODM，大功率快速升温，广泛适用于卧室、客厅及商业空间。",
  ...
  "jd-33k": {
    zh: "JD-33K 板式散热器采用三面板三对流片结构（Type 33），散热量高达 1100–8000 W，是板式系列中功率最强的型号，专为大空间及高热负荷场景设计。可选高度 300–900 mm，钢制冷轧板粉末喷涂白色 RAL 9016，符合 CE/EN442 标准，工作压力 1.0 MPa。自2002年起出口至欧洲、俄罗斯及中亚市场，支持 OEM/ODM，极速升温，适用于大型客厅、展厅、工业厂房等高功率需求场合。",
    en: "The JD-33K is the highest-output model in the panel radiator range, combining triple panels and triple convectors for heat delivery of 1100–8000 W — designed for large spaces and high heat-load requirements. Available in heights from 300 to 900 mm, the cold-rolled steel body carries a powder-coated White RAL 9016 finish and complies with CE/EN442 standards at 1.0 MPa (10 bar). Backed by over two decades of export experience to Europe, Russia and Central Asia since 2002, with OEM/ODM manufacturing services available.",
  },
  "jd132-60tl": {
